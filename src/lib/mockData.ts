...
export const mockMenu: MenuItem[] = [
  ...
  // Chaat (4PM - 7PM)
  { id: "ch1", name: "Golgappe (5 pcs)", description: "Crispy hollow puris filled with tangy tamarind water and spiced potato.", price: 20, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1606491956689-2ea866880c84?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true, tags: ["Trending"] },
  { id: "ch2", name: "Dahi Papdi Chat", description: "Crispy papdis layered with yogurt, chutneys and chaat masala.", price: 50, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1625398407796-82650a8c135f?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "ch3", name: "Papdi Chat", description: "Crunchy papdis topped with potatoes, chickpeas and tangy sauces.", price: 60, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "ch4", name: "Bhalla Chat", description: "Soft urad dal vadas soaked in yogurt with sweet and spicy chutneys.", price: 60, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1630001471987-ff6e8ebcf55e?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "ch5", name: "Samosa Chat", description: "Crushed samosas smothered in yogurt, tamarind and green chutney.", price: 40, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1601050690597-df0568f70950?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "ch6", name: "Bhelpuri", description: "Puffed rice tossed with onions, tomatoes, sev and tangy chutneys.", price: 40, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1606491956689-2ea866880c84?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "ch7", name: "Mung Dal Pakodi", description: "Crispy moong dal fritters served with spiced green chutney.", price: 50, category: "Chaat (4PM-7PM)", imageUrl: "https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },

  // Juices & Shakes
  { id: "j1", name: "Pineapple Juice", description: "Fresh cold-pressed pineapple juice, sweet and tropical.", price: 40, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1589733955941-5eeaf752f6dd?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "j2", name: "Mosmbi Juice", description: "Freshly squeezed sweet lime juice, light and refreshing.", price: 40, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "j3", name: "Watermelon Juice", description: "Chilled fresh watermelon juice, hydrating and naturally sweet.", price: 40, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "j4", name: "Carrot Mix Juice", description: "Nutritious blend of fresh carrot with a hint of ginger.", price: 40, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1612345892738-2ca7c619e79f?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "j5", name: "Banana Shake", description: "Thick creamy banana milkshake blended with cold milk.", price: 60, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1572490122747-3f2e1e65c7b8?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "j6", name: "Mango Shake", description: "Rich and creamy Alphonso mango blended with chilled milk.", price: 60, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1546548970-71785318a17b?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true, tags: ["Seasonal"] },
  { id: "j7", name: "Mocktails", description: "Refreshing mocktails available in mint mojito and blue lagoon.", price: 60, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1527661591475-527312dd65f5?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "j8", name: "Flavored Milkshake (Choc/Vanilla/Strawberry)", description: "Thick milkshakes available in chocolate, vanilla or strawberry flavor.", price: 60, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true, tags: ["Bestseller"] },
  { id: "j9", name: "Flavored Milkshake (Choc/Oreo/KitKat)", description: "Indulgent milkshakes in chocolate, Oreo or KitKat flavor.", price: 70, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1541658016709-82835d52ac77?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "j10", name: "Cold Drink", description: "Chilled cold drinks — small (25) or large (40).", price: 25, category: "Juices & Shakes", imageUrl: "https://images.unsplash.com/photo-1629203851122-3726ecdf080e?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },

  // Ice Creams
  { id: "ic1", name: "Ice Cream", description: "Assorted ice cream flavors served at MRP.", price: 30, category: "Ice Creams", imageUrl: "https://images.unsplash.com/photo-1560008581-09826d1de69e?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true, tags: ["MRP"] },
  { id: "ic2", name: "Softy / With Cone", description: "Soft serve ice cream — plain (25) or in a crispy cone (35).", price: 25, category: "Ice Creams", imageUrl: "https://images.unsplash.com/photo-1514849302-984523450cf4?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },

  // Maggi Magic Bowls
  { id: "mg1", name: "Maggi Original Masala", description: "Classic Maggi noodles cooked in the original masala seasoning.", price: 35, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true, tags: ["Bestseller"] },
  { id: "mg2", name: "Maggi Double Masala", description: "Double the masala punch in a hearty bowl of Maggi noodles.", price: 40, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "mg3", name: "Maggi Butter Garlic", description: "Maggi noodles tossed in rich butter and roasted garlic.", price: 50, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "mg4", name: "Maggi with Oregano", description: "Maggi noodles seasoned with Italian oregano for a fusion twist.", price: 50, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "mg5", name: "Maggi Veg Atta Masala", description: "Wholesome atta Maggi noodles cooked with fresh veggies.", price: 50, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "mg6", name: "Maggi Peri Peri", description: "Fiery Peri Peri spiced Maggi noodles for heat lovers.", price: 55, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true, tags: ["Hot"] },
  { id: "mg7", name: "Maggi BBQ", description: "Maggi noodles blended with smoky BBQ seasoning.", price: 55, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true },
  { id: "mg8", name: "Maggi Oregano Cheese Pazza", description: "Maggi pazza loaded with oregano and melted cheese.", price: 50, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: true, isVeg: true },
  { id: "mg9", name: "Maggi Cheesy Tomato Pazza", description: "Tangy tomato Maggi pazza finished with a generous cheese topping.", price: 50, category: "Maggi Magic Bowls", imageUrl: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?q=80&w=600", isAvailable: true, isPopular: false, isVeg: true }
];
